...
/*                                                                                      */
/* Each day we reload the planned scheduling in order to retrieve all possible updates. */
...
/* Read the Reade file and the wiki to understand each step of the code.                */
/*                                                                                      */
/* Improve:                                                                             */
/*          - botton and led for reset the scheduling                                   */
/*                                                                                      */
